<template>
  ...
  >
    ...
    >
      ...
      >
        <view
          v-if="conversation.type !== '@TIM#SYSTEM'"
          :id="item.ID"
        >
          <view class="t-message-item">
            ...
            >
              ...
              <view
                class="read-receipts"
                v-if="conversation.type === 'C2C' && item.flow === 'out'"
              >
                <view v-if="item.isPeerRead">
                  已读
                </view>
                <view v-else>
                  未读
              ...
              <view>
                ...
                ></TUI-ImageMessage>
                <TUI-VideoMessage
                  v-if="item.type === 'TIMVideoFileElem'"
                  :message="item"
                  :is-mine="item.flow === 'out'"
                ></TUI-VideoMessage>
                <TUI-AudioMessage
...
<script>
import TUITextMessage from "@/components/tui-chat/message-elements/text-message/index";
import TUIImageMessage from "@/components/tui-chat/message-elements/image-message/index";
import TUIVideoMessage from "@/components/tui-chat/message-elements/video-message/index";
import TUIAudioMessage from "@/components/tui-chat/message-elements/audio-message/index";
import TUICustomMessage from "@/components/tui-chat/message-elements/custom-message/index";
import TUITipMessage from "@/components/tui-chat/message-elements/tip-message/index";
import TUISystemMessage from "@/components/tui-chat/message-elements/system-message/index";
import TUIFaceMessage from "@/components/tui-chat/message-elements/face-message/index";
import TUIFileMessage from "@/components/tui-chat/message-elements/file-message/index";
  ...
  methods: {
    ...
    scrollToButtom(){
      const query = uni.createSelectorQuery().in(this),
        nodesRef = query.select("#message-scroll");
      nodesRef
