    ...
    <view class="TUI-message-input-container">
      <view class="TUI-commom-function">
        <view
          ...
          :key="index"
          class="TUI-commom-function-item"
          :data-function="item"
      ...
      <view class="TUI-message-input">
        <image
          class="TUI-icon"
          @tap="switchAudio"
          :src="isAudio ? '/static/assets/tim//keyboard.svg' : '/static/assets/tim//audio.svg'"
        ></image>
        <view
          v-if="!isAudio"
        ...
        >
          <image
            class="TUI-icon"
            @tap="handleEmoji"
            src="~@/static/assets/tim//face-emoji.svg"
          ></image>
          <view
            v-if="!sendMessageBtn"
          ...
          >
            <image
              class="TUI-icon"
              src="~@/static/assets/tim//more.svg"
            ></image>
          </view>
          <view
            v-else
            class="TUI-sendMessage-btn"
            @tap="sendTextMessage"
          >
            发送
          </view>
      ...
      >
        ...
        <view
          ...
          @tap="handleSendPicture"
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//take-photo.svg"
          ></image>
        ...
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//send-img.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            发送图片
          </view>
        ...
        <view
          class="TUI-Extension-slot"
          @tap="handleShootVideo"
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//take-video.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            拍摄视频
          </view>
        ...
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//send-video.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            发送视频
          </view>
        ...
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//audio-calling.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            语音通话
          </view>
        ...
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//video-calling.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            视频通话
          </view>
        ...
        <view
          class="TUI-Extension-slot"
          @tap="handleServiceEvaluation"
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//service-assess.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            服务评价
          </view>
        ...
        >
          <image
            class="TUI-Extension-icon"
            src="~@/static/assets/tim//send-order.svg"
          ></image>
          <view class="TUI-Extension-slot-name">
            发送订单
          </view>
...
import TUICommonWords from "@/components/tui-chat/message-private/common-words/index";
import TUIOrderList from "@/components/tui-chat/message-private/order-list/index";
import TUIServiceEvaluation from "@/components/tui-chat/message-private/service-evaluation/index";
...
export default {
  ...
  methods: {
    ...
    handleCalling(value){
      // todo 目前支持单聊
      if("GROUP" === this.conversation.type){
        uni.showToast({
          title: "群聊暂不支持",
          icon: "none"
        });
