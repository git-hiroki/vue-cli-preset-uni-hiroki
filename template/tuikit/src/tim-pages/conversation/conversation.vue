...
export default {
  ...
  methods: {
    handleRoute(id){
      const url = `/tim-pages/chat/chat?conversationID=${id}`;
      uni.navigateTo({
        url
      });
    },
    ...
    $createConversation(){
      uni.navigateTo({
        url: "tim-pages/create-conversation/create"
      });
    },

    $createGroup(){
      uni.navigateTo({
        url: "tim-pages/create-group/create"
      });
    },

    $joinGroup(){
      uni.navigateTo({
        url: "tim-pages/join-group/join"
      });
    }
  }
};
