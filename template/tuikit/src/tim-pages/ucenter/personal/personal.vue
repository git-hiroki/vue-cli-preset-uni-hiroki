  ...
  <view>
    <view class="container">
      ...
      <view class="item">
        <view
          class="nickname"
          @tap="handleEditToggle"
        >
          <text class="aside-left">
            昵称
          </text>
          <text class="aside-right">
            {{userInfo.nick ? userInfo.nick : '提莫'}}
          </text>
          <image
            class="listimage"
            src="~@/static/assets/tim/detail.svg"
    ...
    <view
      class="popup-mask-avatar"
      v-if="popupToggleAvatar"
      @tap.stop="handleEditToggleAvatar"
    >
      <view
        class="popup-main-avatar"
        @tap.stop="handleCatchTap"
      >
        <view
          class="pop-main-header-avatar"
          :data-item="item"
        >
          <label class="popup-main-header-title-avatar">设置头像</label>
          <label
            class="button-avatar"
            @tap.stop="handleEditSubmitAvatar"
          >确认</label>
