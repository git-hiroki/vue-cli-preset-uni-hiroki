...
export default {
      ...
      userListInfo: [
        {
          ...
          iconUrl: "/static/assets/tim/Privacyregulations.svg"
        },
        {
          extra: 1,
          name: "用户协议",
          ...
          nav: "User-Agreement",
          iconUrl: "/static/assets/tim/Useragreement.svg"
        },
        {
          extra: 3,
          name: "免责声明",
          iconUrl: "/static/assets/tim/Disclaimers.svg"
        },
        {
          extra: 2,
          name: "关于",
          url: "/tim-pages/ucenter/about/about",
          iconUrl: "/static/assets/tim/about.svg"
        },
        {
          extra: 1,
          name: "联系我们",
          path: "https://cloud.tencent.com/document/product/269/20043",
          iconUrl: "/static/assets/tim/contact.svg"
        }
      ],
      config: {
        nick: "",
  ...
  methods: {
    ...
    personal(){
      ...
      uni.navigateTo({
        url: "/tim-pages/ucenter/personal/personal"
      });
    },
    ...
    handleRouter(event){
      ...
      if(data.url){
        ...
        uni.navigateTo({
          url: `/tim-pages/ucenter/webview/webview?url=${data.path}&nav=${data.nav}`
        });
      }
    },
